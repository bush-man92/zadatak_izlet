...
Revision ID: 2dfe4c13957b
Revises: 
Create Date: 2019-01-28 15:30:38.734697
...
def upgrade():
    ...
    op.create_index(op.f('ix_comments_comments'), 'comments', ['comments'], unique=False)
    ...
    sa.PrimaryKeyConstraint('user_id', 'trip_id', 'comments_id')
    )
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_comments_comments'), table_name='comments')
